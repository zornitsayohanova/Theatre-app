        ...
        */
        ...
        var updateCart = function updateCart(action, id, type, previousType, emit) {
            ...
            if (action === 'remove') {
                ...
                if (cartTable) {
                    ...
                    ticketPrice.textContent = '{0}{1}'.format(current.price.toFixed(2), options.cart.currency, );
                }
        ...
        var rightClickDelete = function rightClickDelete(e) {
            ...
            if (type !== undefined) {
                ...
                updateTotal();
                this.style.backgroundColor = "rgb(47, 94, 120)";
            }
            ...
            for (var n = 0; n < options.types.length; n += 1) {
                ...
                for (var l = 0; l < seatType.selected.length; l += 1) {
                      ...
                      if (!element.className.includes("blank")) {
                       ...
                       /* if (!element.className.includes("blank")) {
                            element.classList.add('available');
                            element.classList.add("kl");
                            element.style.backgroundColor = backgroundColor;
                        } else {
                            element.classList.add("kls");
                        }*/
                    }
                }
            }
